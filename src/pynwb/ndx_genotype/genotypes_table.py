...
class GenotypesTable(DynamicTable):
    ...
    def add_genotype(self, **kwargs):
        ...
        if self.alleles_table is None:
            self.alleles_table = AllelesTable(name='alleles_table')

        # TODO confirm that the alleles columns, if passed in, point to the alleles table
    ...
    def get_allele(self, **kwargs):
        # TODO fill me in -- get allele by symbol
        pass
    ...
    #     """
    #
    #     nwbfile = super().get_ancestor(data_type='GenotypeNWBFile')  # TODO changeme to NWBFile after migration
    #     if nwbfile is None:
